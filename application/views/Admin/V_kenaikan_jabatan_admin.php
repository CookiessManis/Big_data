        ...
        <div style="padding-top: 75px; padding-bottom: 35px">
          ...
          >
            ...
            >
              ...
              <tbody>
                <?php  $no =1;
                foreach ($kenaikan_pangkat as $k) {
                  if ($k->status == 'kenaikan jabatan') {
                  ?>
                ...
                <tr class="text-start fw-semibold" style="font-size: 20px">
                  ...
                  <td
                    ...
                    "
                  >
                   <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#HapusModal<?= $k->id_kenaikan ?>">Hapus</button>
                  </td>
                </tr>
                <?php  }} ?>
              </tbody>
				...
				<!-- Modal -->
<?php foreach ($kenaikan_pangkat as $k) {?>

<div class="modal fade" id="HapusModal<?= $k->id_kenaikan ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h1>Apakah Anda Ingin Menghapus Data (<?= $k->nama ?>)</h1>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
       	<a href="<?= base_url('Admin/C_perpindahan_jabatan/delete/' . $k->id_kenaikan) ?> " class=" btn btn-danger "> Hapus</a>
...
<?php } ?>
				...
				<script>
<?php foreach($kenaikan_pangkat as $value) { ?>
    function downloadZip<?= $value->id_kenaikan ?>() {
        ...
        foreach ($fileFields as $field) {
            ?>
           zip.file("Kenaikan_jabatan(<?= $value->nama ?>)/<?= $value->{$field} ?>", fetchContent(baseUrl + '/assets2/files/<?= $value->{$field} ?>'));
            <?php
        }
        ?>
...
function fetchContent(url) {
                ...
                <div style="padding-top: 75px; padding-bottom: 35px">
                  ...
                  >
                    ...
                    >
                      ...
                      <tbody>
                      <form action="<?= base_url('C_notif/tambah_notif_kenaikan_jabatan') ?>" method="post">
                        <tr
                        ...
                        >
                          ...
                          <td
                            ...
                            class="px-3"
                          >
                            <input type="checkbox" name="sertifikat_diklat" value=" Dokumen Penetapan Formasi masih kosong" style="width: 100%" />
                          </td>
                        </tr>
                        <tr
                          class="text-start fw-semibold"
                        ...
                        >
                          <td
                            ...
                            "
                          >
                            SK Pangkat Terakhir Pengangkatan dalam Jabatan
                            Fungsional
                          </td>
                          <td
                            style="
                            ...
                            class="px-3"
                          >
                            <input type="checkbox" name="sk_terakhir" value="SK Pangkat Terakhir Pengangkatan dalam Jabatan
                            Fungsional masih kosong" style="width: 100%" />
   ...
   <script>
    ...
    function jabatan(){
      ...
      $.ajax({
        <?php foreach ($kenaikan_pangkat as $p) { ?>
          url: "<?= base_url('Admin/C_kenaikan_jabatan/load_user/' . $p->id_kenaikan) ?>",
          <?php } ?>
