...
class C_perpindahan_jabatan extends CI_Controller{
    ...
    public function index(){
        ...
        'jumlah_notif' => $this->M_notif->get_jumlah_notif(),
         ...
         $this->load->view('User/V_perpindahan_jabatan', $data);
    ...
    public function tambah() {
        ...
        $data = array(
         ...
         $config['allowed_types'] = 'doc|docx|pdf|PDF|sql|pdf';
         $config['max_size'] = 0;
	 ...
	 public function view_edit($id_kenaikan){
        ...
        $this->load->view('User/templates_user/Sidebar', $data);
       $this->load->view('User/templates_user/Header', $data);
       $this->load->view('User/V_edit_perpindahan_jabatan', $data);
       $this->load->view('User/templates_user/Footer', $data);
    }
	 ...
	 public function delete($id_kenaikan)
  {
    ...
    redirect('User/C_perpindahan_jabatan');
  }
}
